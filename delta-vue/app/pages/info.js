...
module.exports = defineComponent({
  ...
  template: `
    <main class="mt-3 mx-3">
      ...
      <section class="grid" v-if="activeTabs === 1">
        <div class="message box is-4 is-child box is-vertical">
      ...
      <section class="message" v-if="activeTabs === 2">
        ...
        <article class="message-body grid">
          <ul class="cell is-4 is-vertical" v-for="(diskInfo, i) of disksInfo" :key="i">
      ...
      <section class="message" v-if="activeTabs === 3">
        ...
        <article class="message-body grid">
          <ul class="cell is-4 is-vertical" v-for="(controller, i) of graphicsInfo.controllers" :key="i">
          ...
          <ul class="cell is-4 is-vertical" v-for="(display, i) of graphicsInfo.displays" :key="i">
